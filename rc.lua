...
globalkeys = awful.util.table.join(
		...
		function ()
            if client.focus then
				...
				local screen = mouse.screen
       			if curidx == 1 then
           			awful.client.movetotag(awful.tag.gettags(screen)[9])
       			else
           			awful.client.movetotag(awful.tag.gettags(screen)[curidx-1])
       			end
				awful.tag.viewprev()
       	    end
        end),
	awful.key({ modkey, "Shift"   }, "Right", 
		function ()
            if client.focus then
				...
				local screen = mouse.screen
      			if curidx == 9 then
           			awful.client.movetotag(awful.tag.gettags(screen)[1])
       			else
           			awful.client.movetotag(awful.tag.gettags(screen)[curidx + 1])
       			end
				awful.tag.viewnext()
	...
	awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn(lilyterm) end),
